...
import { Platform, Linking, StatusBar, I18nManager, BackHandler, Alert, Text } from 'react-native';
...
export default class App extends Component<Props> {
  ...
  _handleOpenURL(event) {
    ...
    if (routeName == 'momboss' && id == 1) {
      alert("you have purchase plan congratulations, now you can brows more functionality")
    } else if (routeName == 'momboss' && id == 0) {
      alert("oppss!! Something went wrong with purchase the package, Please try again")
    }
  }
