...
class orderStore {
    ...
    @observable LISTING_UPDATE = false;
    @observable LIST_ID = '';
    // Packages GET/POST
    @observable PACKAGES_OBJ = {};
    @observable PACKAGES = [];
    // SavedListing 
