...
class Api {
  ...
  static func = async (route, params, verb) => {
    // console.log("sssssssssssssssssssssss", route, params, verb);
    const host = base_url;
    ...
    // console.log(options, nxxx, hash);
    return await fetch(url, options)
      .then((resp) => {
        console.log(
          "Api response is aaaaaaaaaaaaaaaaaaaaaaaa ------------->>>>>>",
          resp,
          options
        );

        let json = resp.json();
        console.log("assssssssssssssssssssssssssssss", json);
      ...
      .then((json) => {
        console.log(
          "Api response is asaskdskldkkdkdkiiksss ------------->>>>>>",
          json
        );
  ...
  static formDataPost = async (route, formData, verb) => {
    ...
    return fetch(url, options)
      .then((resp) => {
        console.log("Api response is  bbbbbbbbb------------->>>>>>", resp);
      ...
      .then((json) => {
        console.log("Api response is fffffffff ------------->>>>>>", json);
        return json;
      })
      .catch((error) => {
        throw error;
  ...
  static axios = async (route, formData, config) => {
    ...
    return axios.post(url, formData, configration);
    // .then((response)=>{
