...
import {
  Platform, SafeAreaView,I18nManager, Text, View, ImageBackground, Image, TouchableOpacity, ScrollView, TextInput, FlatList, ActivityIndicator, RefreshControl
} from 'react-native';
import {
  AdMobBanner,
  AdMobInterstitial,
...
import styles from '../../../styles/Home4';
import ApiController from '../../ApiController/ApiController';
import ListingComponent from './ListingComponent4';
                        ...
                        home.location_list.map((item, key) => {
                          return (
                            <TouchableOpacity style={{ height: height(16), width: width(43), marginRight: width(3), marginVertical: 5, alignItems: 'center', }}
                              ...
                              <View style={{ width: width(43.5), paddingHorizontal: wp('5'), paddingVertical: wp('3'), backgroundColor: '#fff', borderRadius: wp(3), backgroundColor: "#fff" }}>
                                <Avatar
                                  size="medium"
                                  rounded
