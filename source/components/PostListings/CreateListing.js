  ...
  getAmenities = async (cate_id) => {
    if (cate_id !== "") {
      this.setState({
        cate_id: cate_id,
        loading: true,
        is_picker: Platform.OS === "ios" ? false : false,
      });
      let response = await ApiController.post("get-amenities", {
        category_id: cate_id,
        listing_id: store.LISTING_UPDATE ? store.LIST_ID : "",
      });
          ...
          >
            ...
            {Platform.OS === "android" ? (
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  this.setState({ is_picker: !this.state.is_picker })
                }
              >
                ...
                <View style={{ alignItems: "flex-start" }}>
                  ...
                  <View
                    style={{
                      ...
                      flexDirection: "row",
                      borderRadius: 4,
                      backgroundColor: COLOR_SECTIONS,
                    }}
                  >
                    <View
                      style={{
