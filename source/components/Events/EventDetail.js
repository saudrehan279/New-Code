...
import {
  Text, View, Image, TouchableOpacity, FlatList, ActivityIndicator, ScrollView, TextInput, Modal, I18nManager
} from 'react-native';
...
@observer export default class EventDetail extends Component<Props> {
  ...
  render() {
    ...
    // alert(JSON.stringify(eventDetail.event_detial))
    var region = {
      latitude: parseFloat(eventDetail.event_detial.event_latitude ? eventDetail.event_detial.event_latitude : 0.0236),
      longitude: parseFloat(eventDetail.event_detial.event_longitude ? eventDetail.event_detial.event_longitude : 37.9062),
