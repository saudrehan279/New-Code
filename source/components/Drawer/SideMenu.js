      ...
      <View style={[styles.container, { backgroundColor: data.sidebar_clr }]}>
        <ScrollView>
            ...
            <View style={styles.headerCon}>
                  ...
                  source={{
                    uri:
                      login.loginStatus === true
                        ? login.loginResponse.data.profile_img
                        : data.user_defualt_img,
                  }}
              ...
              {login.loginStatus === true ? (
                <Text style={styles.userName}>
                  {login.loginResponse.data.display_name}
                </Text>
              ) : null}
              {login.loginStatus === true ? (
                <Text style={styles.userEmail}>
                  {login.loginResponse.data.user_email}
                </Text>
              ) : null}
            </View>
          ) : null}
          <TouchableOpacity
            ...
            onPress={this.navigateToScreen("Home", data.menu.home)}
          >
            <View style={styles.itemIconCon}>
              <Form name="home" size={22} color="red" />
            </View>
            <View style={styles.itemTxtCon}>
              <Text style={styles.itemTxt}>{data.menu.home}</Text>
            </View>
          </TouchableOpacity>
          {login.loginStatus === true ? null : data.menu_options
              .sb_listing_menu_opt ? (
            <TouchableOpacity
              style={styles.drawerItem}
            ...
            >
              <View style={styles.itemIconCon}>
                <Form name="form" size={22} color="red" />
              </View>
              <View style={styles.itemTxtCon}>
          ...
          {login.loginStatus === true ? (
            <View>
              ...
              >
                <View style={styles.itemIconCon}>
                  <Form name="plussquareo" size={22} color="red" />
                </View>
                <View style={styles.itemTxtCon}>
                  ...
                  <Image
                    source={
                      this.state.isCollapsed === false
                        ? require("../../images/next_White.png")
                        : require("../../images/down-ar-white.png")
                    }
                    style={[styles.itemIcon, { height: height(2) }]}
                  />
                </View>
              </TouchableOpacity>
              {this.state.isCollapsed === true ? (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Form name="setting" size={22} color="red" />
                    </View>
                    <View style={styles.itemTxtCon}>
                  ...
                  >
                    ...
                    >
                      <Form name="staro" size={22} color="red" />
                    </View>
                    <View style={styles.itemTxtCon}>
                  ...
                  >
                    ...
                    >
                      <Form name="calendar" size={22} color="red" />
                    </View>
                    <View style={styles.itemTxtCon}>
                      <Text style={styles.itemTxt}>
                  ...
                  >
                    ...
                    >
                      <Form name="hearto" size={22} color="red" />
                    </View>
                    <View style={styles.itemTxtCon}>
                      <Text style={styles.itemTxt}>
                        {data.menu.saved_listings}
          ...
          <TouchableOpacity
            ...
            onPress={this.navigateToScreen(
              "SearchingScreen",
              data.menu.adv_search
            )}
          >
            <View style={styles.itemIconCon}>
              <Form name="search1" size={22} color="red" />
            </View>
            <View style={styles.itemTxtCon}>
          ...
          {data.menu_options.sb_event_menu_opt ? (
            <TouchableOpacity
              style={styles.drawerItem}
              onPress={this.navigateToScreen("PublicEvents", data.menu.events)}
            >
              <View style={styles.itemIconCon}>
                <Form name="calendar" size={22} color="red" />
              </View>
              <View style={styles.itemTxtCon}>
                <Text style={styles.itemTxt}>{"Events & Special Offers"}</Text>
              </View>
            </TouchableOpacity>
          ) : null}
          {data.menu_options.sb_blog_menu_opt ? (
            <TouchableOpacity
              style={styles.drawerItem}
              onPress={this.navigateToScreen("blogStack", data.menu.blog)}
            >
              <View style={styles.itemIconCon}>
                <Form name="profile" size={22} color="red" />
              </View>
              <View style={styles.itemTxtCon}>
          ...
          {data.menu_options.sb_categories_menu_opt ? (
            <TouchableOpacity
              style={styles.drawerItem}
              onPress={this.navigateToScreen("Categories", data.menu.cats)}
            >
              <View style={styles.itemIconCon}>
                <Form name="windowso" size={22} color="red" />
              </View>
              <View style={styles.itemTxtCon}>
          ...
          {data.menu_options.sb_packages_menu_opt ? (
            <TouchableOpacity
              style={styles.drawerItem}
              onPress={this.navigateToScreen("Packages", data.menu.packages)}
            >
              <View style={styles.itemIconCon}>
                <Form name="rocket1" size={22} color="red" />
              </View>
              <View style={styles.itemTxtCon}>
            ...
            ? data.menu_options.sb_language_menu_opt
              ? [
                  <TouchableOpacity
                    ...
                    onPress={this.navigateToScreen(
                      "Language",
                      data.menu.dwt_app_selct_language
                    )}
                  >
                    <View style={styles.itemIconCon}>
                      <Image
          ...
          {data.menu_options.sb_about_us_menu_opt
            ? [
                <TouchableOpacity
                  style={styles.drawerItem}
                  onPress={this.navigateToScreen("AboutUs", data.menu.about)}
                >
                  <View style={styles.itemIconCon}>
                    <Image
                      source={require("../../images/aboutus_white.png")}
                      resizeMode="contain"
                      style={{ height: wp("5") }}
                    />
                  </View>
          ...
          {data.menu_options.sb_contact_us_menu_opt
            ? [
                ...
                >
                  <View style={styles.itemIconCon}>
                    <Image
                      source={require("../../images/contactus_white.png")}
                      resizeMode="contain"
                      style={{ height: wp("5") }}
                    />
                  </View>
            ...
            : []}
          {data.menu_options.sb_loging_register_menu_opt != undefined &&
          data.menu_options.sb_loging_register_menu_opt ? (
            login.loginStatus === false ? (
              <View>
                ...
                >
                  <View style={styles.itemIconCon}>
                    <Form name="lock" size={22} color="red" />
                  </View>
                  <View style={styles.itemTxtCon}>
        ...
        >
          ...
          >
            ...
            >
              <LottieView
                source={require("../../animations/1174-warning.json")}
                autoPlay
                loop
              />
            </View>
            ...
            >
              {"Update your package to create listing!!"}
            </Text>
